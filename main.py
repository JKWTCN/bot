...
import json
import bot_database
from group_member import get_group_member_list
import luck_dog
                        ...
                        case "group":
                            ...
                            match message["message"][0]["type"]:
                                case "text":
                                    ...
                                    if (
                                        sender["user_id"] == setting.miaomiao_group_member
                                        and "喵"
                                    ...
                                    if (
                                        ...
                                        if (
                                            ...
                                            if sender["user_id"] not in setting.admin_list:
                                                await websocket.send(
                                                    json.dumps(
                                                        ban_new(
                                                            sender["user_id"],
                            ...
                            match message["user_id"]:
                                case 1505617447 | 3070004098:
                                    if message["raw_message"].startswith(
                                        ...
                                        await websocket.send(
                                            json.dumps(
                                                get_group_member_list(setting.admin_group_main)
                                            )
                                        )
